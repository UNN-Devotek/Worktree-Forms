...
export function SheetList({ projectSlug }: SheetListProps) {
  ...
  return (
    <div className="space-y-4 p-6">
      <div className="flex justify-between items-center">
        <div>
          <h1 className="text-2xl font-bold tracking-tight">Project Spreadsheets</h1>
          <p className="text-muted-foreground text-sm">
            Manage your project data, schedules, and trackers.
          </p>
        </div>
              ...
              <TableRow>
                <TableCell colSpan={6} className="h-32 text-center text-muted-foreground">
                  <div className="flex flex-col items-center gap-2">
                    ...
                    <p>No sheets found. Create your first one to get started.</p>
                  </div>
                </TableCell>
              </TableRow>
            ) : (
