...
export function ProjectFolderTree({ className }: ProjectFolderTreeProps) {
  const { items, currentFolderId, expandedFolders, toggleFolder, setCurrentFolder } = useProjectFileSystemStore()
