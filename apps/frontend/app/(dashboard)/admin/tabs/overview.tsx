    ...
    return (
        <div className="space-y-6 pb-8">
            <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
                <StatsCard title="Total Revenue" value="$1,250.00" trend="Trending up this month" trendDirection="up" subtext="Visitors for the last 6 months" />
                <StatsCard title="New Customers" value="1,234" trend="Down 20% this period" trendDirection="down" subtext="Acquisition needs attention" />
                <StatsCard title="Active Accounts" value="45,678" trend="Strong user retention" trendDirection="up" subtext="Engagement exceed targets" />
                <StatsCard title="Growth Rate" value="4.5%" trend="Steady performance" trendDirection="neutral" subtext="Meets growth projections" />
            </div>
